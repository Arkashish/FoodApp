...
const Footer = () => {
  return (
    <div>
      <footer className="footer p-10 bg-base-200 xl:px-24 py-10 px-4 text-base-content flex justify-between">
        <aside>
      ...
      <footer className="footer footer-center p-4 px-24 py-10 px-4 bg-base-300 text-base-content">
        <aside>
          <p>Copyright © 2025 - All right reserved by FoodApp Ltd</p>
        </aside>
      </footer>
    </div>
  );
